...
a.range <- 3.5 # width for uniform distribution
...
```{r env-storing, eval=FALSE}
 write.csv(df.coef, file = here("BH_simulations/Box/SimulationsDataFiles/parameters_opt.csv"))
 write.csv(df.result, file = here("BH_simulations/Box/SimulationsDataFiles/simulation_opt.csv"))

# Simple R version of BH_Simulations_many.Rmd to make running on Teton easier
# Note that this is therefore missing a lot of the comments present in that file

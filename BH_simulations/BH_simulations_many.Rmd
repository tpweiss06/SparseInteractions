...
Single simulation run. sUses the functions above to simulate plot communities deterministically to near-equilibrium values, perturb species populations, and then look at stochastic population change from that perturbed state to the following time step. Has default inputs for standard function runs.
```{r run-simulation}
